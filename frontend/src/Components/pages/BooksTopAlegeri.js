...
import '../styles/BooksTopAlegeri.css'
...
function BooksTopAlegeri(props) {
    ...
    return (
        ...
        <> <h1>{t("TOP ALEGERI RECOMANDATE PENTRU TINE")}</h1>
        <div className='books_content'>
            ...
            <div className='book_page'>
                    ...
                    <div className='books_details'> <h3> {book.booktitle}</h3></div>
                    <br />
                    <div><img className="img_book" src={book.imageurls} alt={book.id} /></div>
                    <br />
...
export default BooksTopAlegeri
/*
import React, {useState, useEffect} from 'react';
import axios from 'axios';
